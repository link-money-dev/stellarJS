$.extend(true, $.fn.dataTable.defaults, {
    ...
    oLanguage: {sLengthMenu: "_MENU_ 條/頁"}
});
        ...
        fnInit: function (oSettings, nPaging, fnDraw) {
            ...
            if (oPaging.iTotalPages < iListLength) {
                ...
                if (oPaging.iPage <= iHalf) {
                    ...
                    if (oPaging.iPage >= (oPaging.iTotalPages - iHalf)) {
...
$(document).ready(function () {
    $("#dtable").dataTable({
        sDom: "<'row-fluid dt-header'<'span6'f><'span6 hidden-phone'T>r>t<'row-fluid dt-footer'<'span6 hidden-phone'i><'span6'p>>",
        sPaginationType: "bootstrap",
        oLanguage: {sLengthMenu: "Showing: _MENU_", sSearch: ""},
        oTableTools: {
            ...
            }, {sExtends: "xls", sButtonText: '<i class="cus-doc-excel-table oTable-adjust"></i> Save for Excel'}]
        }
    });
